...
st.subheader("設定一根 K 棒的時間長度(星期)")
cycle_duration_weeks = st.number_input('輸入一根 K 棒的時間長度(單位:星期)', key="KBar_duration_weeks", min_value=1)
cycle_duration_minutes = int(cycle_duration_weeks * 7 * 1440)  # 每星期有 7 天，每天有 1440 分鐘
cycle_duration_minutes = 2 * 7 * 1440  # 這行代碼將 K 棒週期設置為固定值，例如 2 星期
